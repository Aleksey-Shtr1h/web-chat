...
export const FormRegistrationItem = styled(FormMainItem)`
  ${({ valid }) =>
    valid
      ? 0
...
export const FormRegistrationInput = styled(FormMainInput)`
  font-size: ${getAdaptiveSizePx(
    12,
    18,
    SizeNumberWidth.smPhoneWidth,
  ...
  border: ${({ valid }) => (valid ? "3px solid #fff;" : "3px solid red")};
`;
